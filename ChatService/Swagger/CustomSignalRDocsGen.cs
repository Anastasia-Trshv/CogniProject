...
public class CustomSigRDocsGen : IDocumentFilter
{
    public void Apply(OpenApiDocument swaggerDoc, DocumentFilterContext context)
    {
        ...
        var methods = typeof(ChatHubController).GetMethods();
        ...
        if (methods != null)
        {
            foreach (var method in methods) {
                ...
                var op = invokableAttribute.EndpointOverride == null ? OperationType.Head : 
                    invokableAttribute.EndpointOverride == ChatHubController.HUB_ENDPOINT ? OperationType.Trace : OperationType.Get;
